...
#include "dice.hpp"
//----------------------------------------------------------------
Dice::Dice(int sides, int dice): nSides(sides), nDice(dice), values(new int[nDice]){
    srand(time(NULL));
}
...
ostream& Dice::print(ostream& out)const{
    ...
    out << "\n+-----+\t" << "+-----+\t" << "+-----+\t" << "+-----+" << endl;
    out << "¦ " << dot[1] << " " << dot[2] << " ¦\t" << "¦ " << dot[8] <<" " << dot[9] << " ¦\t" << "¦ " << dot[15] <<" " << dot[16] << " ¦\t" << "¦ " << dot[22] <<" " << dot[23] << " ¦" << endl;
    out << "¦ " << dot[3] << dot[4] << dot[5] << " ¦\t" << "¦ " << dot[10] << dot[11] << dot[12] << " ¦\t" << "¦ " << dot[17] << dot[18] << dot[19] << " ¦\t" << "¦ " << dot[24] << dot[25] << dot[26] << " ¦" << endl;
    out << "¦ " << dot[6] << " " << dot[7] << " ¦\t" << "¦ " << dot[13] <<" " << dot[14] << " ¦\t" << "¦ " << dot[20] <<" " << dot[21] << " ¦\t" << "¦ " << dot[27] <<" " << dot[28] << " ¦" << endl;
    out << "+-----+\t" << "+-----+\t" << "+-----+\t" << "+-----+" << endl;
